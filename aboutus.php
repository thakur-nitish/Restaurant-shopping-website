...
<html>
  ...
  <head>
    <title> About | Digilogix Cafe' </title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Digilogix Cafe'</a>
        </div>
...
?>
    ...
    <div class="wide">
        ...
        <div class="tagline">It's not our <font color="red"><strong>work life.</strong></font><br><font color="green"><strong><em>In the year 2011, DigiLogix Technologies Pvt. Ltd. is formed with it's Registered Office at New Delhi and Corporate office at Kolkata. We have been developing various customized software and website solutions for the Hospitality, Education and Travel industry since 2005 by the name "iNet Solution Inc".</em>.</strong></font></div>
        <h3 style="color: red">About the food culture in Digilogix cafe'</h3>
        <br>
